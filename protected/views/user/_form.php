...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'has_checked_in'); ?>
		<?php echo $form->textField($model,'has_checked_in'); ?>
		<?php echo $form->error($model,'has_checked_in'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'ipad_num'); ?>
		<?php echo $form->textField($model,'ipad_num'); ?>
		<?php echo $form->error($model,'ipad_num'); ?>
	</div>
